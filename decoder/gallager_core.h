/*
 * File:   gallager_core.h
 * Author: Canales-Martinez, Isaac Andres
 */

#ifndef GALLAGER_CORE_H
#define GALLAGER_CORE_H
 ...
 * Notes:
 *   It is assumed that:
 *     - r1, r2, s, h0 and h1 are not null pointers, and
 *     - the elements of s, h0 and h1 are integers between 0 and q-1, inclusive.
 *   The pointers r1 and r2 should not be equal to s, h0 or h1.
 */
